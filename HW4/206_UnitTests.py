...
class CardTests(unittest.TestCase):
	...
	# that contains a dictionary with the identification of face cards.
	def test_facecard(self):
		c = Card()
		self.assertEqual(c.faces,{1:"Ace",11:"Jack",12:"Queen",13:"King"})

	# Test that if the str method is called on a card instance that is a face card,
	# it will print out its correct face instead of a number.
	def test_facecard1(self):
		c = Card(rank=11,suit=3)
